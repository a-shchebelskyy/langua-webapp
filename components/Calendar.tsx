...
const Calendar = () => {
    ...
    //     const modal = await DayPilot.Modal.prompt("Створити новий урок:", "Event 1");
    ...
    return (
        <div className="flex flex-col">
            ...
            <div className="flex mb-8">
                    <div className="flex flex-row p-1 rounded-xl bg-neutral-100">
                        {/* <button onClick={() => setView("Day")} className={view === "Day" ? "flex p-3 text-sm text-black rounded-lg bg-white" : "flex p-3 text-sm text-neutral-500"}>Day</button> */}
                        <button onClick={() => setView("Week")} className={view === "Week" ? "flex py-2 px-3 items-center text-sm text-black rounded-lg bg-white shadow-md" : "flex px-3 py-2 text-sm text-neutral-500"}>Week</button>
                        <button onClick={() => setView("Month")} className={view === "Month" ? "flex py-2 px-3 items-center text-sm text-black rounded-lg bg-white shadow-md" : "flex px-3 py-2 text-sm text-neutral-500"}>Month</button>
                    </div>
